 ...
 *
 * USAGE:
 *   node scripts/refundCommunityRewardsAutopositioning.js --dry
 *   node scripts/refundCommunityRewardsAutopositioning.js --date 2025-12-13 --dry
 *   node scripts/refundCommunityRewardsAutopositioning.js --from 2025-12-01 --to 2025-12-05
 */
...
async function start() {
  ...
  sheet.columns = [
    ...
    { header: "COMMUNITY_REWARDS Before", key: "crBefore", width: 22 },
    { header: "COMMUNITY_REWARDS After", key: "crAfter", width: 22 },
  ...
  for (const log of logs) {
    ...
    const crBefore = Number(ledger.wallets.communityRewards || 0); // only for report
