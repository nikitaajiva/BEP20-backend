 ...
 *
 * Usage:
 *   node scripts/listUnfundedWithdrawalErrors.js                # DRY-RUN (today only)
 *   node scripts/listUnfundedWithdrawalErrors.js --apply        # APPLY (today only)
...
const REGEX = CODES
  ...
  : flag('regex', 'temBAD_AMOUNT|tefPAST_SEQ|Unexpected server response: 429'); // default to both
