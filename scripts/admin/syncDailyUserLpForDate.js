...
/* ===============================
   CONFIG
================================ */
const TARGET_DATE = new Date("2026-01-02T00:00:00.000Z"); // 👈 SET DATE HERE
...
const LOG_FILE = path.join(
  LOG_DIR,
  `dailyuserlp-sync-${TARGET_DATE.toISOString().slice(0, 10)}-${new Date()
    .toISOString()
    .replace(/[:.]/g, "-")}.log`
);
...
const USERS = [
  ...
  { email: "BEPVault5425@gmail.com", lp: 5000 },
  { email: "BEPVault54526@gmail.com", lp: 4900 },
  { email: "BEPVault54527@gmail.com", lp: 4000 },
  { email: "BEPVault54528@gmail.com", lp: 5500 },
  { email: "BEPVault54524@gmail.com", lp: 4300 },
  { email: "BEPVault54529@gmail.com", lp: 5700 },
  { email: "BEPVault1212@gmail.com", lp: 5000 },
  { email: "BEPVault8@gmail.com", lp: 1000 },
  ...
  { email: "BEPVault570@gmail.com", lp: 3500 },
  { email: "BEPVault810@gmail.com", lp: 6500 },
  { email: "BEPVault425@gmail.com", lp: 3600 },
  { email: "BEPVault50@gmail.com", lp: 6400 },
  ...
  { email: "BEPVault1111@gmail.com", lp: 2500 },
  { email: "BEPVault011@gmail.com", lp: 5000 },
  ...
  { email: "BEPVault@outlook.com", lp: 6300 },
...
(async () => {
  try {
    ...
    log(`📅 Target Date: ${TARGET_DATE.toISOString()}`);
    ...
    for (const u of USERS) {
      ...
      if (!ledger?.wallets?.lp) {
        log("⚠️ LEDGER LP NOT FOUND");
        skipped++;
        continue;
      }

      const ledgerLp = Number(ledger.wallets.lp.toString());
      ...
      if (!dailyLp) {
        log("⚠️ DAILYUSERLP RECORD NOT FOUND FOR DATE");
        skipped++;
        continue;
      }

      const oldLp = dailyLp.lp;

      dailyLp.lp = ledgerLp;
      await dailyLp.save();

      log(
        `✅ UPDATED | LP ${oldLp} → ${ledgerLp} | Date ${TARGET_DATE
          .toISOString()
          .slice(0, 10)}`
      );
